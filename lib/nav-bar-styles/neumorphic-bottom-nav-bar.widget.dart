...
class NeumorphicBottomNavBar extends StatelessWidget {
  ...
  NeumorphicBottomNavBar({Key? key, this.navBarEssentials, this.neumorphicProperties = const NeumorphicProperties()});

  Widget _getNavItem(PersistentBottomNavBarItem item, bool isSelected, double? height) =>
      this.neumorphicProperties != null && this.neumorphicProperties!.showSubtitleText
          ? Column(
        ...
        : opaque(this.navBarEssentials!.items!, this.navBarEssentials!.selectedIndex)
            ? NeumorphicContainer(
                decoration: NeumorphicDecoration(
                  ...
                  shape: this.neumorphicProperties == null ? BoxShape.rectangle : this.neumorphicProperties!.shape,
                ),
            ...
            : Container(
                decoration: BoxDecoration(
                  ...
                  color: getBackgroundColor(context, this.navBarEssentials!.items,
                      this.navBarEssentials!.backgroundColor, this.navBarEssentials!.selectedIndex),
                ),
                height: height! + 20,
                width: 60.0,
                padding: EdgeInsets.all(6.0),
        ...
        children: this.navBarEssentials!.items!.map((item) {
          ...
          return Flexible(
            child: GestureDetector(
              ...
              child: _buildItem(
                  context, item, this.navBarEssentials!.selectedIndex == index, this.navBarEssentials!.navBarHeight),
            ),
          );
        }).toList(),
      ),
